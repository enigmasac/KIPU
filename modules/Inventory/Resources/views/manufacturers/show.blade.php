                    ...
                    <div class="info-card">
                        ...
                        <div class="info-card-content">
                            ...
                            <span class="info-card-number">
                                <x-money :amount="$amounts['paid']" :currency="setting('default.currency')" convert />
                            </span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                ...
                <div class="col-md-4 col-sm-8 col-xs-12">
                    <div class="info-card">
                        ...
                        <div class="info-card-content">
                            ...
                            <span class="info-card-number">
                                <x-money :amount="amounts['open']" :currency="setting('default.currency')" convert />
                            </span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    ...
                    <div class="info-card">
                        ...
                        <div class="info-card-content">
                            ...
                            <span class="info-box-number">
                                <x-money :amount="$amounts['overdue']" :currency="setting('default.currency')" convert />
                            </span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
