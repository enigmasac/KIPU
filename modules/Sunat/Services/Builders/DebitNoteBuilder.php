...
class DebitNoteBuilder
{
    ...
    {
        $note = new Note();
        $number = $document->document_number ?? 'FD01-1';
        ...
        $note
            ...
            ->setCodMotivo($document->debit_note_reason_code ?? '01')
            ->setDesMotivo(config('sunat.debit_note_reason_codes')[$document->debit_note_reason_code ?? '01'] ?? 'Intereses por mora')
